...
<head>
        ...
        <title>Single Product || cakraelektronik - Digital Products Store eCommerce Bootstrap 4 Template</title>
	...
	<![endif]-->
        ...
        <div class="body-wrapper">
            ...
            $id = $_GET['id'];
            $query = mysqli_query($koneksi, "SELECT p. *,nm_kategori FROM tb_produk p
