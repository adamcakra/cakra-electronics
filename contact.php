...
<head>
        ...
        <title>Hubungi kami | cakraelektronik</title>
                        ...
                        <div class="col-lg-5 offset-lg-1 col-md-12 order-1 order-lg-2">
                            <div class="contact-page-side-content">
                                ...
                                <div class="single-contact-block">
                                    ...
                                    <p>Mobile: (08) 96 5464 4345</p>
                                    <p>Hotline: 1009 678 456</p>
                                </div>
                                <div class="single-contact-block last-child">
                                    <h4><i class="fa fa-envelope-o"></i> Email</h4>
                                    <p>@cakraelektronik.com</p>
                                    <p>support@cakraelektronik.company</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <ul class="des">
                                    ...
                                    <li>
                                        <span>Email: </span>
                                        <a href="mailto:info@cakraelektronik.id">info@cakraelektronik.id</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="footer-block">
                                    ...
                                    <ul class="social-link">
                                        ...
                                        <li class="instagram">
                                            <a href="https://instagram.com/cakraprama/" data-toggle="tooltip" target="_blank" title="Instagram">
