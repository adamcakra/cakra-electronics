...
if (!empty($_GET['id'])) {
    ...
    // Check apakah order exists with matching id and id_user
    ...
    echo "<script>alert('Pesanan tidak ditemukan atau bukan milik Anda.'); window.location='cart.php';</
    script>";

    }
}else{
     echo "<script>alert('Permintaan tidak valid (id kosong).'); window.location='cart.php';</
    script>";
}
